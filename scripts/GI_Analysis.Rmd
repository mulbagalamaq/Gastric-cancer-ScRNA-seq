...
```{r qc_scatter, warning=FALSE, message=FALSE, fig.width=12, fig.height=4}
...
```{r elbow_plot, warning=FALSE, message=FALSE, fig.width=6, fig.height=4}
...
```{r harmony_integration, warning=FALSE, message=FALSE}
...
```{r cluster_markers, warning=FALSE, message=FALSE}
...
```{r cluster_heatmap, warning=FALSE, message=FALSE, fig.width=16, fig.height=8}
...
```{r m2ts_wilcox, warning=FALSE, message=FALSE}
